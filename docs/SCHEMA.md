...
| brand_color | TEXT NULL | **법인 브랜딩** — 포인트 컬러 `#rrggbb`. 지원 페이지·AI 면접 화면·지원자 발송 메일의 헤더 밴드 배경 + 제출/CTA 버튼에 적용, 밴드 위 글자색은 YIQ 밝기로 자동 결정(`lib/brand-color.ts` — 대비 시스템 보장). NULL=기본 테마 (0053) |
