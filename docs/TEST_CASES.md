...
**결과 요약(8):** 32 / 33 통과 + 1 SKIP (TC-8.4.1 외부 URL). 일부(8.3.3/8.3.6/8.3.7, 8.4.3/8.4.4/8.4.6, 8.2.7, 8.5.3, 8.6.2)는 코드 검증 — 후보 의존/UI/외부 케이스. 핵심 보안(SSRF·PIN·멀티테넌트) 실테스트 통과. ⚠️ dev 서버 stale로 export 일시 404(재시작 해결, 제품버그 아님).
