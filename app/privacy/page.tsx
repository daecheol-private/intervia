    ...
    <main className="max-w-6xl mx-auto w-full px-4 sm:px-6 py-6 sm:py-8">
      ...
      <Section n="5" title="개인정보 처리위탁">
        ...
        <p className="mt-3 text-xs text-ink-soft">
          ...
          원본(OCR)·음성 데이터는 항상 국내에서만 처리됩니다. 안내·통보 메일은
          국내 메일 서버((주) 엑스퍼넷·대한민국)에서 발송하는 것을 원칙으로 하며(국외
          이전 없음), 해당 서버의 점검·장애 시에 한해 대체 경로(Resend·미국)로
          발송될 수 있습니다. 위 임시 처리 및
          호스팅(Vercel·미국)·데이터베이스(Turso·일본 도쿄)·메일 발송 대체
          경로(Resend·미국) 등 인프라 단계의 국외이전은 PIPA §28의8 에 따라 본
