 ...
 *
 * - 지원자 평가: candidates/392 의 *실제* 종합평가(overview 탭 재현) — PII 가명
 * - AI 면접: 3단계 중 심층면접 채팅 화면 재현 (대화는 임의)
 * - 면접 문제 생성: 392 1차 *실제* 질문지 표시 (회사명 일반화)
 * - 라이브 녹음: 대면 면접 화자분리 + 추천질문 화면 재현 (녹취는 임의)
 *
...
// ── 탭1: 지원자 평가 (실제 overview 재현 — 392 실제 데이터) ────────────
function EvalScreen() {
  return (
