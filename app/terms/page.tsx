  ...
  return (
    <main className="max-w-6xl mx-auto w-full px-4 sm:px-6 py-6 sm:py-8">
      ...
      <Section n="7" title="토큰 및 결제">
        <ul className="list-disc list-inside space-y-1">
          <li>
            ...
            유상 토큰의 환급을 청구할 수 있습니다 (제7-2조 환불 정책에 따름).
          </li>
          <li>
          ...
          <li>
            ...
            토큰은 소멸하며, 소멸한 토큰에 대해서는 환급을 청구할 수 없습니다.
            무상으로 지급된 토큰(쿠폰·보너스)의 유효기간은 지급 시 안내된
            기간을 따릅니다.
          </li>
          <li>
      ...
      <Section n="7-2" title="환불 정책">
        ...
        <ul className="list-disc list-inside space-y-1">
          <li>
            <strong>환불 청구 기한</strong>: 환급 청구는 해당 결제일로부터 1년
            이내에 하여야 합니다. 유상 충전 토큰의 유효기간이 충전일로부터
            1년이므로(제7조), 그 기간이 지난 결제분은 잔액이 소멸하여 환급
            대상이 아닙니다.
          </li>
          <li>
          ...
          <li>
            <strong>7일 경과 후 ~ 결제일로부터 1년 이내</strong>: 유상 충전분의
            미사용 잔액은 환급을 청구할 수 있습니다 (환급 수수료 10% 이내 공제
            가능, 무상 지급분·보너스 토큰은 제외).
          </li>
          <li>
            <strong>강제 해지 시</strong>: 약관 위반으로 강제 해지된 경우에도
            결제일로부터 1년 이내인 유상 충전분의 미사용 잔액은 환급합니다.
          </li>
          <li>
      ...
      <Section n="10" title="계약 해지">
        ...
        유상 충전분 미사용 잔액은 환불 정책(제7-2조, 결제일로부터 1년 이내)에
        따라 환급하고, 무상 지급분은 소멸하며, 마이너스 잔액은 종료 전
        정산하여야 합니다.
      </Section>
