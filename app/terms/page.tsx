  ...
  return (
    <main className="max-w-6xl mx-auto w-full px-4 sm:px-6 py-6 sm:py-8">
      ...
      <Section n="7" title="토큰 및 결제">
        <ul className="list-disc list-inside space-y-1">
          <li>
            ...
            시 7일 전 서비스 내 공지하며, 인상에 동의하지 않는 법인은 이용계약을
            해지하고 미사용 유상 토큰의 환불을 청구할 수 있습니다 (제7-2조 환불
            정책에 따름).
          </li>
          <li>
          ...
          <li>
            무상으로 지급된 토큰(쿠폰·보너스)의 유효기간은 지급 시 안내된 기간을
            따릅니다. 유상으로 충전한 토큰의 이용기간은 제7-1조에 따릅니다.
          </li>
          <li>
            카드 결제는 1회 결제금액 10만원(부가세 포함) 이하의 정해진 금액으로만
            충전할 수 있으며, 그보다 큰 금액은 계좌이체로 충전하고 세금계산서를
            발행합니다.
          </li>
        </ul>
      </Section>

      <Section n="7-1" title="충전 토큰의 결제">
        <ol className="list-decimal list-inside space-y-1">
          <li>
            토큰 충전 후 환불은 결제가 이루어진 결제수단으로만 진행됩니다 (현금
            등 다른 수단으로 환불하지 않습니다).
          </li>
          <li>
            충전된 토큰은 회원(법인) 간 양도가 불가하며, 판매하거나 현금으로
            교환할 수 없습니다.
          </li>
          <li>
            충전된 토큰(포인트)의 이용기간과 환불가능기간은 결제시점으로부터
            1년 이내로 제한됩니다. 이용기간이 지난 유상 토큰은 소멸하며, 소멸한
            토큰은 환불되지 않습니다.
          </li>
        </ol>
      </Section>

      <Section n="7-2" title="환불 정책" id="refund-policy">
        <p>
          회사는 법정 의무 적용 여부와 무관하게 다음 기준으로 환불합니다. 모든
          환불은 결제시점으로부터 1년 이내인 결제분에 한하여, 결제가 이루어진
          결제수단으로 진행됩니다 (제7-1조).
        </p>
        <ul className="list-disc list-inside space-y-1">
          <li>
            <strong>사용하지 않은 충전분</strong>: 충전한 토큰을 사용하지 않은
            경우(환불 요청 시점의 잔액이 해당 결제로 지급된 토큰 이상인 경우)
            해당 결제 전액을 취소합니다.
          </li>
          <li>
            <strong>사용한 충전분</strong>: 충전한 토큰을 일부라도 사용한
            경우에는 환불하지 않습니다.
          </li>
          <li>
            <strong>이용계약 해지·서비스 종료 시</strong>: 법인이 이용계약을
            해지(탈퇴)하거나 약관 위반으로 이용계약이 해지된 경우, 또는 회사가
            서비스를 종료하는 경우에는 결제시점으로부터 1년 이내인 유상
            충전분의 미사용 잔액을 환불합니다. 법인의 해지에 따른 환불은 환불
            금액의 10% 이내에서 환급 수수료를 공제할 수 있으며, 회사의 서비스
            종료에 따른 환불은 공제하지 않습니다.
          </li>
          <li>
            <strong>회사 귀책 결제 오류</strong>: 중복 결제 등 회사의 귀책사유로
            결제 오류가 발생한 경우 해당 결제를 취소합니다.
          </li>
          <li>
            <strong>무상 토큰</strong>: 쿠폰·보너스 등 무상으로 지급된 토큰은
            환불 대상이 아니며, 결제를 취소하면 그 결제로 지급된 보너스 토큰도
            함께 회수합니다.
          </li>
          <li>
      ...
      <Section n="8" title="서비스의 중지 및 변경">
        ...
        토큰을 복구하거나 보상 토큰을 지급합니다 (현금 환급은 제7-2조 환불
        정책에 따릅니다).
      </Section>
      ...
      <Section n="10" title="계약 해지">
        ...
        유상 충전분 미사용 잔액은 환불 정책(제7-2조, 결제시점으로부터 1년
        이내)에 따라 환불하고, 무상 지급분은 소멸하며, 마이너스 잔액은 종료 전
        정산하여야 합니다.
      </Section>
      ...
      <Section n="12" title="약관의 개정">
        <ul className="list-disc list-inside space-y-1">
          ...
          <li>
            해지 시 미사용 유상 토큰은 환불 정책(제7-2조)에 따라 환급합니다.
          </li>
        </ul>
      </Section>
