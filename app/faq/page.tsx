  ...
  const GROUPS: { category: string; items: { q: string; a: ReactNode }[] }[] = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          q: "토큰에 유효기간이 있나요?",
          a: "유상 충전 토큰의 이용기간과 환불가능기간은 결제시점으로부터 1년 이내입니다. 토큰은 다른 법인에 양도하거나 현금으로 교환할 수 없습니다.",
        },
        {
          q: "카드로 얼마까지 충전할 수 있나요?",
          a: "카드는 1회 결제 10만원(VAT 포함) 이하의 정해진 금액으로만 충전할 수 있습니다. 10만원 이상은 계좌이체로 충전하며 세금계산서를 발행하고, 금액에 따라 보너스 토큰을 드립니다.",
        },
        {
          q: "충전한 금액을 환불받을 수 있나요?",
          a: (
            <>
              충전한 토큰을 사용하지 않았다면 결제시점으로부터 1년 이내에 결제
              전액을 취소해 드립니다. 일부라도 사용했다면 환불되지 않으며,
              이용계약을 해지하거나 서비스가 종료될 때 1년 이내 결제분의 미사용
              잔액을 환불합니다. 환불은 결제한 수단으로만 진행됩니다. 자세한
              기준은{" "}
              <Link href="/terms#refund-policy" className={linkCls}>
                이용약관 제7-2조 환불 정책
              </Link>
              을 확인해 주세요.
            </>
