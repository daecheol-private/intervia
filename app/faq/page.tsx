  ...
  const GROUPS: { category: string; items: { q: string; a: ReactNode }[] }[] = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          q: "토큰에 유효기간이 있나요?",
          a: "유상 충전 토큰의 유효기간은 충전일로부터 1년입니다. 토큰은 양도·환금할 수 없습니다.",
        },
        {
          q: "충전한 금액을 환불받을 수 있나요?",
          a: (
            <>
              결제 후 7일 이내는 전액 환불되고, 그 이후에도 결제일로부터 1년
              이내라면 미사용 잔액을 환급받을 수 있습니다 (환급 수수료 10% 이내
              공제 가능, 무상 지급분·보너스 토큰 제외). 자세한 기준은{" "}
