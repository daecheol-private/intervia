        ...
        <Container width="lg" className="py-20 sm:py-24">
          ...
          <div className="mt-10 rounded-2xl bg-primary text-surface p-6 sm:p-10 shadow-lg reveal">
            ...
            <p className="mt-5 text-[11px] opacity-70 text-center">
              ※ 신규 법인 최초 등록 1회 한정. 위 건수는 무료 체험 토큰을 한 종류에만 썼을 때 기준. 기능이 성공할 때만 토큰이 차감됩니다.
            </p>
          </div>
          ...
          <div className="mt-10 reveal">
            ...
            <p className="mt-4 text-[11px] text-ink-soft text-center">
              카드는 1회 결제 10만원(VAT 포함) 이하로 충전하고, 10만원 이상은 계좌이체(세금계산서 발행)로 충전합니다. 진행 중인 평가·면접은 잔액이 부족해도 끝까지 완료됩니다(부족분은 다음 충전 시 자동 정산). 잔액이 0 이하가 되면 충전 전까지 신규 작업이 차단됩니다.
            </p>
          </div>
        </Container>
      </section>
