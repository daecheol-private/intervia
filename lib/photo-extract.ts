...
// 상한 근거는 "A4 전면 스캔의 최소 해상도" 다 — 150dpi A4 = 1240x1754 라 긴 변 1700 을
// 넘지 않으면 스캔 페이지가 아니다. 1400 이던 시절 스마트폰/스튜디오 원본 증명사진
// (실측 1104x1440, 면적 1.59M)이 스캔본으로 오인돼 통째로 버려졌다.
const MAX_LONG_SIDE = 1700; // px — 이보다 길면 전면 스캔 페이지(증명사진 아님)일 확률↑
const MAX_AREA = 2_000_000; // px² — 전면 페이지 이미지(150dpi A4 = 2.17M) 배제
