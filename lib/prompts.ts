...
→ **석사·박사 등 상위 학위 자체는 약간의 가점** — 주로 growth_attitude(학습 깊이 신호), JD 관련 전공이면 tech_fit·role_match 에 소폭. 단 실무 경력 우위를 뒤집지 못하고, 학위만으로 각 축 하드캡을 넘기지 못한다.
...
- **상위 학위(석사·박사)** = 약간의 가점 (주로 growth_attitude, JD 관련 전공이면 tech_fit·role_match 에 소폭).
